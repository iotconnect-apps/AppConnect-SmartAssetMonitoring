...
namespace host.iot.solution.Controllers
{
    ...
    public class DashboardController : BaseController
    {
        ...
        //public Entity.BaseResponse<Entity.EntityDashboardOverviewResponse> GetEntityDetail([FromQuery]OverviewEntityRequest overviewRequest)
        //{
        //    if (overviewRequest.entityId == null || overviewRequest.entityId == string.Empty)
        //    {
        //        return new Entity.BaseResponse<Entity.EntityDashboardOverviewResponse>(false, "Invalid Request");
        //    }

        //    Entity.BaseResponse<Entity.EntityDashboardOverviewResponse> response = new Entity.BaseResponse<Entity.EntityDashboardOverviewResponse>(true);
        //    try
        //    {
        //        response = _entityService.GetEntityDetail(Guid.Parse(overviewRequest.entityId), overviewRequest.currentDate.Value, overviewRequest.timeZone);
        //    }
        //    catch (Exception ex)
        //    {
        //        base.LogException(ex);
        //        return new Entity.BaseResponse<Entity.EntityDashboardOverviewResponse>(false, ex.Message);
        //    }
        //    return response;
        //}
        [HttpPost]
        [Route(DashboardRoute.Route.GetEntityDetail, Name = DashboardRoute.Name.GetEntityDetail)]
        [EnsureGuidParameter("entityId", "Location")]
        public Entity.BaseResponse<Entity.EntityDashboardOverviewResponse> PostEntityDetail([FromBody] OverviewEntityRequest overviewRequest)
        {
            if (overviewRequest.entityId == null || overviewRequest.entityId == string.Empty)
            {
                return new Entity.BaseResponse<Entity.EntityDashboardOverviewResponse>(false, "Invalid Request");
