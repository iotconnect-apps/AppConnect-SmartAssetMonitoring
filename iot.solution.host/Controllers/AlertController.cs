...
namespace iot.solution.host.Controllers
{
    ...
    public class AlertController : BaseController
    {
        ...
        public Entity.BaseResponse<Entity.SearchResult<List<Entity.AlertResponse>>> GetBySearch(string deviceGuid = "", string parentEntityGuid="",string entityGuid = "", int? pageNo = 1, int? pageSize = 10, string orderBy = "")
        {
