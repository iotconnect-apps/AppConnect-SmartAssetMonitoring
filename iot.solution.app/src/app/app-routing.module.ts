...
import {
  ...
  AssetTypesComponent, AddTypeComponent, AssetsListComponent, AssetDashboardComponent, AddAssetComponent,DynamicDashboardComponent
...
const appRoutes: Routes = [
  ...
  {
    path: 'assets-types/:assetTypeGuid',
    component: AddTypeComponent,
    canActivate: [AdminAuthGuard]
  },
  {
    path: 'assets-types/add',
    component: AddTypeComponent,
    canActivate: [AdminAuthGuard]
  },
  {
  ...
  {
    path: 'assets/dashboard/:assetGuid',
