  ...
  getInventoryDetails(inventoryGuid) {
    ...
    this._service.getInventoryDetails(inventoryGuid).subscribe(response => {
      if (response.isSuccess === true) {
        ...
        if (response.data.entityGuid) {
          this.getDeviceLookup(response.data.entityGuid);
        }
        if (response.data.productTypeGuid) {
          this.getProductLookup(response.data.productTypeGuid);
        }
        if (response.data.deviceGuid) {
          this.getProductTypeLookup(response.data.deviceGuid);
          this.getSheflIDLookup(response.data.productTypeGuid);
        }
      } else {
