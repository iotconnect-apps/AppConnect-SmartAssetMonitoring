...
export class AddLocationComponent implements OnInit {
  ...
  constructor(
    ...
    this.activatedRoute.params.subscribe(params => {
      if (params.locationGuid != 'add') {
        ...
        this.getcountryList();
        this.locationObject = { name: '', zipcode: '', countryGuid: null, stateGuid: null, isActive: 'true', city: '', latitude: '', longitude: '' }
      }
    });
  }
  ...
  createFormGroup() {
    this.locationForm = this.formBuilder.group({
      parentEntityGuid: [''],
      countryGuid: [null, Validators.required],
          ...
          reader.onload = (innerEvent: any) => {
            ...
            img.onload = () => {
              ...
              if (this.fileToUpload.size > 2000000) {
                ...
                this.fileName = "";
                this.myFile.nativeElement.value = "";
                that.locationObject.image = null;
                this.spinner.hide();
                return;
              }
    ...
    this.locationService.getLocatinDetails(locationGuid).subscribe(response => {
      if (response.isSuccess === true) {
        ...
        if (this.locationObject.image) {
          this.locationObject.image = this.locationObject.image;
